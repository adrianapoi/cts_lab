...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Numar punte bonus: " + puncteBonus);
	...
	RemoteControll remote =  new RemoteControll(lightOnCommand, lightOffCommand, dimLightCommand, increaseIntensityCommand);
	remote.pressLightOn();
	remote.pressIncreaseLightCommand();
